<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="LoginRequerimientosTEC.Update" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:Button ID="Button1" runat="server" class="myButton" OnClick="Button1_Click" Text="Update" />
                </td>
